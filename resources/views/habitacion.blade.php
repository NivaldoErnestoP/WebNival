...
<head>
    ...
    <link rel="stylesheet" href="{{asset('estilos/StyleMenu/styleHabitacion.css')}}">
...
<body class="body">
    <div class="div_body">
        ...
        <header style="background: #202020" class="header_habitacion">
            <div class="div_header">
                <a class="local" href="{{route('home')}}">
                    <h1 style="color: #fff !important" title="Inicio" class="titulo-local">Local Frontera</h1> </a>
                ...
                <nav class="class_nav">
                    ...
                    <ul id="menu" class="nav-menu">
                       <div class="div_li-1">
                           ...
                           <li id="id_li-1" class="li-2"><a href="#" class="link_nav">Habitación</a></li>
    ...
    <article class="class_articulo">
        ...
        <div class="class_img">
            {{-- <img class="img" src="../imagenes/Habitacion2.jpg" alt="muebles"> --}}
        </div>
    </article>
    <article class="class_articulo-2">
        <div class="div_h2">
            {{-- <h2 class="class_h2">Para La Habitación </h2>                  --}}
        </div>
        ...
        <section class="section-1">
          <div class="div_mag-flex">
              ...
              <div class="div_hogar-fila-1">
                  ...
                  <div class="div_img-1">
                   <img class="img-section" src="../imagenes/CamaHabitacion.jpg" alt="ropero">
                ...
                <div class="div_añadir">
                    ...
                    <div class="div_img-2">
                        <img class="img-section" src="../imagenes/ArmarioHabtacion.jpg" alt="ropero">
                    ...
                    <div class="div_img-3">
                        <img class="img-section" src="../imagenes/GabetaHabitacion.jpg" alt="ropero">
                ...
                <div class="div_hogar-fila-2">
                    ...
                    <div class="div_img-6">
                        <img class="img-section" src="../imagenes/MESA-DE-COMPUTACION Habitacion.jpg" alt="ropero">
                    ...
                    <div class="div_img-7">
                        <img class="img-section" src="../imagenes/SillaHabitacion.jpg" alt="ropero">
                    ...
                    <div class="div_img-8">
                        <img class="img-section" src="../imagenes/mueble_gabeta2.jpg" alt="ropero">
                        <div class="div_precio">
