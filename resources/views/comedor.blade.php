...
<body class="body">
    <div class="div_body">
                ...
                <nav class="class_nav">
                    ...
                    <ul id="menu" class="nav-menu">
                       <div class="div_li-1">
                           ...
                           <li id="id_li-1" class="li-3"><a href="#" class="link_nav">Comedor</a></li>
        ...
        <article class="class_articulo">
            ...
            <div class="class_img">
                <img class="img" src="../imagenes/foto-portadaComedor.jpg" alt="muebles">
            </div>
        </article>
        <article class="class_articulo-2">
            <div class="div_h2">
                <h2 class="class_h2">Para El Comedor </h2>                 
            </div>
              ...
              <div class="div_mag-flex">
                  ...
                  <div class="div_hogar-fila-1">
                    ...
                    <div class="div_añadir">
                        <a class="añadir" href="#" >Mesa Comedor 6 sillas</a>
                    </div>
                        ...
                        <div class="div_img-2">
                            <img class="img-section" src="../imagenes/ComedorMadera-7.jpg" alt="ropero">
                        ...
                        <div class="div_img-3">
                            <img class="img-section" src="../imagenes/ComedorMesasillas-4.jpeg" alt="ropero">
                        ...
                        <div class="div_img-4">
                            <img class="img-section" src="../imagenes/Comedor-3.jpg" alt="ropero">
                    ...
                    <div class="div_hogar-fila-2">
                        ...
                        <div class="div_img-5">
                            <img class="img-section" src="../imagenes/SillaComedor.jpg" alt="ropero">
                        ...
                        <div class="div_img-6">
                            <img class="img-section" src="../imagenes/Sillas.png" alt="ropero">
                        ...
                        <div class="div_img-8">
                            <img class="img-section" src="../imagenes/ComedorRemplaso-2.jpg" alt="ropero">
                            <div class="div_precio">
                    ...
                    <div class="div_hogar-fila-3">
                        ...
                        <div class="div_img-9">
                            <img class="img-section" src="../imagenes/MesaFor.png" alt="ropero">
                            <div class="div_precio">
                        ...
                        <div class="div_img-10">
                            <img class="img-section" src="../imagenes/mesaRemplaso.jpg" alt="ropero">
                        ...
                        <div class="div_img-12">
                            <img class="img-section" src="../imagenes/SillaComedor-6.jpeg" alt="ropero">
